...
export const SubscriptionButtons = () => {
  ...
  const {isActiveSubscription, isLoading, subscription, data} = UseActiveSubscription()

  return (
    <div className="flex flex-col justify-center items-center">
      <Card>
        <CardHeader>
          <CardTitle className="text-center">Polar Checkout
            <CardDescription>
              <Badge className="w-full p-2 rounded-lg" variant={!isActiveSubscription ? 'default' : 'destructive'}>
        ...
        <CardContent>
          <div className="w-full flex flex-col justify-center items-center gap-y-4">
            {!isActiveSubscription && !isLoading && (
              ...
              <Button disabled={false} onClick={() => authClient.checkout({
                slug: 'test-product',
              })} className="w-full">
            ...
            <Button disabled={false} onClick={() => authClient.customer.portal()} className="w-full">
